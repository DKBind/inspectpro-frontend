        ...
        <DialogHeader className="px-7 pt-7 pb-5 border-b border-[#E5E7EB]">
          <div className="flex items-center gap-3 mb-1">
            <div className="h-9 w-9 rounded-xl bg-[#1a7bbd]/10 border border-[#1a7bbd]/30 flex items-center justify-center">
              <GitBranch size={18} className="text-[#1a7bbd]" />
            </div>
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button type="button" onClick={onSave}
        className="shrink-0 px-3 h-9 rounded-md bg-[#1a7bbd] text-white text-xs font-medium hover:bg-[#2a9a84] transition-colors">
        Save
      </button>
      <button type="button" onClick={onDelete}
